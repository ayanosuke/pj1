...
・絶縁用フォトカプラーを使用してデコーダーと電気的絶縁をしています。

・絶縁用@<tt>{USB} シリアル変換基板を搭載。デコーダーと電気的に絶縁して通信できます。

・購入したい方は要ご相談

=== デコーダーをスマイルライターに取り付けます

スマイルデコーダーシリーズは板厚さが@<tt>{1.6mm}のタイプと@<tt>{0.8mm}タイプの2種類があります。スマイルライターコンボAキットは
両方に対応しています。
